    ...
    def initImportProcess(self):
        try:
            if len(self.textureList) >= 1:
                ...
                # Create material
                mat = (bpy.data.materials.get(self.materialName)
                       or bpy.data.materials.new(self.materialName))
                ...
                if "albedo" in maps_:
                    ...
                    imgPath = [item[2]
                               for item in self.textureList if item[1] == "albedo"]
                    if len(imgPath) >= 1:
                ...
                if "roughness" in maps_:
                    ...
                    imgPath = [item[2]
                               for item in self.textureList if item[1] == "roughness"]
                    if len(imgPath) >= 1:
                        imgPath = imgPath[0].replace("\\", "/")
                ...
                if "metalness" in maps_:
                    ...
                    imgPath = [item[2]
                               for item in self.textureList if item[1] == "metalness"]
                    if len(imgPath) >= 1:
                        imgPath = imgPath[0].replace("\\", "/")
